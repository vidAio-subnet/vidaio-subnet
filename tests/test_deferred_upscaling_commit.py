...
class DeferredUpscalingCommitTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_upscaling_batches_are_scored_before_the_round_is_committed(self):
        method = self.methods["process_upscaling_miners"]
        scoring_loop = next(
            node
            ...
            and any(
                ...
                and child.func.attr == "score_upscalings"
        ...
        self.assertTrue(
            any(call.func.attr == "_commit_upscaling_scores" for call in later_calls)
        )

    def test_score_upscalings_preserves_immediate_commit_by_default(self):
        method = self.methods["score_upscalings"]
        ...
        self.assertTrue(
            any(
                isinstance(child, ast.Call)
                and isinstance(child.func, ast.Attribute)
                and child.func.attr == "_commit_upscaling_scores"
