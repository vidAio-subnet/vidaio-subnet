...
class VideoSchedulerConfig(BaseModel):
    ...
    max_synthetic_queue_size: int = Field(default=200)  # Increased from 50
    refill_threshold: int = Field(default=100)  # Increased from 25
    refill_target: int = Field(default=150)  # Increased from 30
    min_video_len: int = Field(default=25)
    max_video_len: int = Field(default=50)
    pexels_max_size: int = Field(default=300)  # Increased from 110
    pexels_threshold: int = Field(default=200)  # Increased from 90
