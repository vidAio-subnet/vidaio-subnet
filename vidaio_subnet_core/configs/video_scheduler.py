...
class VideoSchedulerConfig(BaseModel):
    ...
    refill_threshold: int = Field(default=10) #  90 
    refill_target: int = Field(default=10)  # 100
    min_video_len: int = Field(default=30)# 30
    max_video_len: int = Field(default=40)# 40
    pexels_max_size: int = Field(default=5) # 110
    pexels_threshold: int = Field(default=4)# 90
